...
class EditStocks:UIViewController {
    ...
    func configureUI() {
        ...
        ValueLabelMediumTap.delegate = self
        itemValueLabelSmall.addGestureRecognizer(ValueLabelMediumTap)
        itemValueLabelMedium.setDimensions(width: 226, height: 80)
        ...
        itemValueLabelSmall.addGestureRecognizer(ValueLabelLargeTap)
        itemValueLabelLarge.setDimensions(width: 226, height: 80)
        ...
        smallLabel.setDimensions(width: 226, height: 80)
        ...
        mediumLabel.setDimensions(width: 226, height: 80)
        ...
        largeLabel.setDimensions(width: 226, height: 80)
    ...
    @objc func smallLabelTapped () {
        isSmallTapped = true
        smallLabel.textColor = .systemRed
    ...
    print("plus button pressed")
        ...
        if isSmallTapped == true {
            largeLabelValue += 1
            itemValueLabelLarge.text = String(smallLabelValue)
        }
